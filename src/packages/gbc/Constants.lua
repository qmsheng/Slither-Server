...
_M.WEBSOCKET_SUBPROTOCOL_PATTERN     = "slither%-([%w%d%-]+)" -- token
_M.WEBSOCKET_DEFAULT_TIME_OUT        = 10 * 1000 -- 10s
_M.WEBSOCKET_DEFAULT_MAX_PAYLOAD_LEN = 16 * 1024 -- 16KB
_M.WEBSOCKET_MESSAGE_QUEUE_KEY       = "_WS_MSG_QUEUE_"

-- room
_M.ROOM_PREFIX                       = "rooms:"
_M.ROOM_NEXT_ID_KEY                  = "next_id"
_M.ROOM_LEADERBOARD                  = ":leaderboard"
_M.ROOM_MINMAP                       = ":minmap"
_M.ROOM_LIST                         = _M.ROOM_PREFIX .. "list:"

-- 服务器status
_M.STATUS_PREFIX                     = "status"
_M.STATUS_ROOMS                      = _M.STATUS_PREFIX .. ":rooms"
