...
--截取长度
function cc.pTruncate(pt,len)
  local l = math.min(cc.pGetLength(pt) , len)
  local angle = math.atan2(pt.y, pt.x)
  return {x = math.cos(angle)*l , y = math.sin(angle)*l}
end
